...
for imode = 1:1:3*NUM_ATOMS_UCELL
     for  ikpt = 1:1:nucell
          ...
          p(ikpt,imode)=1/(sum((ii*abs(eigenvec(((NUM_ATOMS_UCELL*3)*(ikpt-1)+1):((NUM_ATOMS_UCELL*3)*ikpt),imode))).^4))/(NUM_ATOMS_UCELL*3*nucell);
