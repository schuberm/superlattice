...
%g(1:3)=(1-alloy_conc)* ((1 - (m1/vm) )^2) + (alloy_conc)* ((1 - (m2/vm) )^2);
%g(10:12)=(1-alloy_conc)* ((1 - (m1/vm) )^2) + (alloy_conc)* ((1 - (m2/vm) )^2);
%g(NMD.NUM_MODES-12:NMD.NUM_MODES-10)=(1-alloy_conc)* ((1 - (m2/vm) )^2) + (alloy_conc)* ((1 - (m1/vm) )^2);
%g(NMD.NUM_MODES-2:NMD.NUM_MODES)=(1-alloy_conc)* ((1 - (m2/vm) )^2) + (alloy_conc)* ((1 - (m1/vm) )^2);
