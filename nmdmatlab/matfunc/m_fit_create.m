...
%NMD_ISEED_IKSLICE.sh------------------------------------------------------        
        ...
        str.cmd4 =...
        [NMD.temp.path '/fit.sh.temp > ./' int2str(NMD.seed.superlattice) '/fit_' int2str(iseed) '_' int2str(imode) '.sh'];
...
%NMD_ISEED_IKSLICE.m-------------------------------------------------------        
        ...
        str.cmd3 =...
            [NMD.temp.path '/fit.m.temp > ./' int2str(NMD.seed.superlattice) '/fit_' int2str(iseed) '_' int2str(imode) '.m'];
