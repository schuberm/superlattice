...
\end{equation}
%%% 
In analyzing the MD velocity data, the Fourier transform sampling window was found to vary depending upon the superlattice system and the frequency of the modes. The number of timesteps for the FFT window and total simulation time are given in Table~\ref{TB:MD_time}.
