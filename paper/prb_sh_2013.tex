...
\caption{Number of timesteps in the Fourier sampling windows, total number of MD timesteps for each superlattice system, and the total number of independent MD simulations. $\omega_H\kv=1$ was found to be the transition frequency, using the $\Gamma\kv \ll \omega_H\kv$ condition as a heuristic guide, in order to obtain convergence for lifetime estimates.}
\label{TB:MD_time}
\end{table*}
%%%
