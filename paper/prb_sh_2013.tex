...
%Larkin observed similar features in alloy systems.\cite{larkin2013predicting}
...
%Larkin and McGaughey found a similar discrepancy between NMD and Tamura theory with GK in LJ alloys.\cite{larkin2013predicting} They proposed to set the diffusivities, $v^{2}_{g,\mathbf{\alpha}}\kv \tau\kv$, of the modes which are less than the diffusivity of the high-scatter limit, $1/3 v^2_sa $, equal to the diffusivity of the high-scatter limit. Here, $v_s$ is the sound speed in the material, which when estimated using the bulk modulus for these superlattices, was found to be 5.11 [LJ units].\cite{GULP}  Applying the diffusivity correction to the in-plane direction, we find that, with the exception of the $2 \times 2$ superlattice, the correction yields predictions within the uncertainty. This correction was not applied to the cross-plane direction, since good agreement was previously established.
